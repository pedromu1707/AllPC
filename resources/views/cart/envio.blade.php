      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">{{ trans('carrito.metodoenvio') }}</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="{{ route('index')}}">Home</a></li>
                <li class="breadcrumb-item active">{{ trans('carrito.metodoenvio') }}</li>
              </ul>
            </div>
          </div>
        </div>
			...
			@endif
                ...
                @csrf
                  <ul class="nav nav-pills nav-fill">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link active"><i class="fa fa-truck"></i><br>{{ trans('carrito.metodoenvio') }}</a></li>
                  ...
                  <div class="content">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="box shipping-method">
                          <h4>SEUR</h4>
                          <p>{{ trans('carrito.2dias') }}</p>
                          <div class="box-footer text-center">
                            <input type="radio" name="envio" value="seur">
                          </div>
                        </div>
                      </div>
                    </div>
