...
<div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">{{$nombre->titulo}}</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="{{ route('index')}}">Home</a></li>
                <li class="breadcrumb-item active">{{$nombre->titulo}}</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div id="content">
        <div class="container">
          <div class="row bar">
            ...
            @endif
            <form method="POST" action="{{route('filtrar.categorias')}}">
                    @csrf
                    ...
                    <div class="row justify-content-around pt-3">
                                    ...
                                    <a class="col-lg-5 col-md-5 btn btn-ligh"href="{{route('productoscat',$categoria)}}">Eliminar Filtros</a>
                                    </div>
                    </form>
                </div>
