...
<div id="heading-breadcrumbs">
    <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
                <h1 class="h2">{{ trans('categorias.ofertas') }}</h1>
            </div>
            <div class="col-md-5">
                <ul class="breadcrumb d-flex justify-content-end">
                    <li class="breadcrumb-item"><a href="{{ route('index')}}">HOME</a></li>
                    <li class="breadcrumb-item active">{{ trans('categorias.ofertas') }}</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row bar">
            ...
            @endif
                    ...
                    <form method="POST" action="{{route('filtrar.ofertas')}}">
                    @csrf
                    ...
                    <div class="row justify-content-around pt-3">
                                    ...
                                    <a class="col-lg-5 col-md-5 btn btn-ligh"href="{{route('ofertas')}}">Eliminar Filtros</a>
                                    </div>
                    </form>
                </div>
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product">
                            <div class="maxproduct"><a href="{{ route('show', $data->idProducto) }}"><img
                                        src="{{asset("{$data->imagen}")}}" alt="" class="img-fluid image1"></a></div>
                            <div class="text">
                                <h3 class="h5"><a href="{{ route('show', $data->idProducto) }}">{{ $data->titulo }}</a>
                                </h3>
